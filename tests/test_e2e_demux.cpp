...
#include "fixtures/webm_fixture.h"
#include "common/MediaLog.h"

namespace {
// Several tests deliberately overflow the StreamReader window; on host builds
// MediaLog writes those warnings to stderr and drowns the results.
struct SilenceLogs {
  SilenceLogs() {
